...
async function seedDatabase() {
  ...
  try {
    ...
    console.log(`📦 Inserting ${sampleProducts.length} curated products...`);
    ...
    if (insertError) {
      // If table has no unique constraint on name, fall back to insert
      ...
      console.log(`✅ Successfully inserted ${directInsert.length} products!`);
    } else {
      console.log(`✅ Successfully seeded/updated ${inserted.length} products!`);
    }
